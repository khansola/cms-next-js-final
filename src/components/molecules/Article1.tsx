            ...
            <div className='flex flex-wrap gap-5 justify-center'>
                {
                    ProgramList.map((e, i) => {
                        return (
                            <div>
                                <div key={i} className='flex flex-wrap justify-center mt-10'>
                                    <Card sx={{ maxWidth: 350, height: 450 }}>
                                        ...
                                        <CardContent>
                                            ...
                                            <Typography className='text-justify' gutterBottom component="div">
                                                {e.desc}
                                            </Typography>
                                            <Typography className='text-left' gutterBottom component="div">
                                                {e.title}
                                            </Typography>
                                        </CardContent>
                                    </Card>
